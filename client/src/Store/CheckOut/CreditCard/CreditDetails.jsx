...
import '../CreditCard/CreditDetails.scss';
    ...
    <>
      <div className="cardetails-wrapper">
        <div className="cardetails-payment">
          <h2 className="carddetails-head">Enter your card information:</h2>
          <div className="cardetails-form">
            <div className="cardetails-card cardetails-space cardetails-icon-relative">
              <label className="cardetails-label">Credit/Debit Card Number</label>
              <input
                type="text"
